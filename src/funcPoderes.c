...
void verificarResposta(ALLEGRO_SAMPLE *som_acertou, ALLEGRO_SAMPLE *som_errou, telaAlternativa *posicaoAlt, listaQuestao *questionario, SpriteSheet *sFantasmas, bonecoJog *jogador){
    //verifica se clique foi na posição da alternativa A
...
void drawPergunta(ALLEGRO_FONT *fonte_equacao, listaQuestao *questionario, telaAlternativa *posicaoAlt){
    ...
    if(questionario->matarFantasma<questionario->QntdRespostaMatarFantasma){
        ...
        al_draw_textf(fonte_equacao, al_map_rgb(245, 245, 245), posicaoAlt->alt_Ax,     posicaoAlt->alt_Ay, ALLEGRO_ALIGN_CENTRE    , "a) %d ", questionario->alternativa_A);
        al_draw_textf(fonte_equacao, al_map_rgb(245, 245, 245), posicaoAlt->alt_Bx,     posicaoAlt->alt_By, ALLEGRO_ALIGN_CENTRE    , "b) %d ", questionario->alternativa_B);
        al_draw_textf(fonte_equacao, al_map_rgb(245, 245, 245), posicaoAlt->alt_Cx,     posicaoAlt->alt_Cy, ALLEGRO_ALIGN_CENTRE    , "c) %d ", questionario->alternativa_C);
    }
    ...
    //if(questionario.matarFantasma>=questionario.QntdRespostaMatarFantasma){
        ...
        al_draw_text(fonte_equacao, al_map_rgb(0, 0, 255), posicaoAlt->pergunta_x , posicaoAlt->pergunta_y,  ALLEGRO_ALIGN_CENTRE, "Cor olho do fantasma:");
